...
my_weight = 'D:/Thai-coin-detection-main/Thai-coin-detection-main/yolov5/weights/coin_v1-9_last.pt'
...
# ----------------- เปลี่ยนจากอ่านกล้อง → อ่านไฟล์จากโฟลเดอร์ -----------------
import glob

image_paths = glob.glob("D:/Thai-coin-detection-main/Thai-coin-detection-main/coin_dataset/images/set1_train/*.jpg")
